...
const PERSONAL_FIELDS = [
  ...
  { key: 'mobile',               label: 'Số điện thoại di động',          placeholder: 'VD: 0901234567',         required: false, type: 'tel' },
  { key: 'email',                label: 'Email',                          placeholder: 'VD: nguyenvana@email.com', required: false, type: 'email' },
  { key: 'passport_number',      label: 'Số hộ chiếu',                    placeholder: 'VD: B1234567',          required: true },
  { key: 'id_number',            label: 'Số CCCD/CMND',                   placeholder: 'VD: 001234567890',       required: false },
  ...
  { key: 'company_address',      label: 'Địa chỉ công ty (tiếng Anh)',    placeholder: 'VD: 456 Le Loi, Hanoi',  required: false },
  { key: 'company_phone',        label: 'SĐT công ty',                    placeholder: 'VD: 0281234567',         required: false, type: 'tel' },
  ...
  { key: 'accommodation_phone',  label: 'SĐT khách sạn',                  placeholder: 'VD: +81-3-1234-5678',    required: false, type: 'tel' },
